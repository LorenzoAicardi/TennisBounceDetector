...
from src.dataloaders import read_image, get_transform, build_img_transforms
from src.utils.image import get_affine_transform, affine_transform
...
class TracknetV2Detector(object):
    ...
    def __init__(self, cfg, model=None):
        ...
        if model is None:
            ...
            # self._model = nn.DataParallel(self._model, device_ids=self._gpus) # uncomment this if using more than 1 gpu
        else:
            self._model = model
