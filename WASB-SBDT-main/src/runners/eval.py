...
from src.utils import mkdir_if_missing, draw_frame, gen_video, Center, Evaluator
...
def inference_video(detector, 
    ...
    for cnt, img_path in enumerate(result_dict.keys()):
        ...
        if vis_traj_path is not None:
            ...
            # vis        = draw_frame(vis, center_gt=center_gt, color_gt=color_gt,) # visualizer.draw_frame (???????)
