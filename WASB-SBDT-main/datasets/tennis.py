...
from src.utils import load_csv_tennis as load_csv
from src.utils import refine_gt_clip_tennis as refine_gt_clip
...
class Tennis(object):
    ...
    def _gen_seq_list(self, 
        ...
        disps              = []
        for match in matches:
            match_clip_dir = self._root_dir + "/" + match  # osp.join(self._root_dir, match)
            print(match)
            print(match_clip_dir)
